...
- Users bind an already-open Google Docs tab from the setup screen in Options.
...
- If the bound tab is gone, the feature falls back to a stale status and requires the user to rebind from Options or from the Meet-side selector.
